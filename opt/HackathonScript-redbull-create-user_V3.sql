...
--https://objectstorage.us-phoenix-1.oraclecloud.com/p/70u9y8PhfH-DOBaYNr8b1dJUcIjnugAXq6IqMAS3j7COM1MDWGN-ku2ZQ_YZYmgD/n/idch4uyl2yza/b/Racing2cloud_hackathon/o/
begin 
    dbms_cloud.copy_data(
	table_name => 'RACES',
	credential_name => null,
	file_uri_list => 'https://objectstorage.us-phoenix-1.oraclecloud.com/p/70u9y8PhfH-DOBaYNr8b1dJUcIjnugAXq6IqMAS3j7COM1MDWGN-ku2ZQ_YZYmgD/n/idch4uyl2yza/b/Racing2cloud_hackathon/o/RACES.csv',    
	...
	credential_name => null,
	file_uri_list => 'https://objectstorage.us-phoenix-1.oraclecloud.com/p/70u9y8PhfH-DOBaYNr8b1dJUcIjnugAXq6IqMAS3j7COM1MDWGN-ku2ZQ_YZYmgD/n/idch4uyl2yza/b/Racing2cloud_hackathon/o/LAP_TIMES.csv',    
	format => json_object('type' value 'csv', 'ignoremissingcolumns' value 'true', 'blankasnull' value 'true' ,'skipheaders' value '1'));
	
	dbms_cloud.copy_data(
	table_name => 'SAFETY_CAR',
	credential_name => null,
	file_uri_list => 'https://objectstorage.us-phoenix-1.oraclecloud.com/p/70u9y8PhfH-DOBaYNr8b1dJUcIjnugAXq6IqMAS3j7COM1MDWGN-ku2ZQ_YZYmgD/n/idch4uyl2yza/b/Racing2cloud_hackathon/o/SAFETY_CAR.csv',    
	format => json_object('type' value 'csv', 'ignoremissingcolumns' value 'true', 'blankasnull' value 'true' ,'skipheaders' value '1'));
	
	dbms_cloud.copy_data(
	table_name => 'PIT_STOPS',
	credential_name => null,
	file_uri_list => 'https://objectstorage.us-phoenix-1.oraclecloud.com/p/70u9y8PhfH-DOBaYNr8b1dJUcIjnugAXq6IqMAS3j7COM1MDWGN-ku2ZQ_YZYmgD/n/idch4uyl2yza/b/Racing2cloud_hackathon/o/PIT_STOPS.csv',    
	format => json_object('type' value 'csv', 'ignoremissingcolumns' value 'true', 'blankasnull' value 'true' ,'skipheaders' value '1'));
	
	dbms_cloud.copy_data(
	table_name => 'RESULTS',
	credential_name => null,
	file_uri_list => 'https://objectstorage.us-phoenix-1.oraclecloud.com/p/70u9y8PhfH-DOBaYNr8b1dJUcIjnugAXq6IqMAS3j7COM1MDWGN-ku2ZQ_YZYmgD/n/idch4uyl2yza/b/Racing2cloud_hackathon/o/RESULTS.csv',    
	format => json_object('type' value 'csv', 'ignoremissingcolumns' value 'true', 'blankasnull' value 'true' ,'skipheaders' value '1'));
	
	dbms_cloud.copy_data(
	table_name => 'DRIVER_STANDINGS',
	credential_name => null,
	file_uri_list => 'https://objectstorage.us-phoenix-1.oraclecloud.com/p/70u9y8PhfH-DOBaYNr8b1dJUcIjnugAXq6IqMAS3j7COM1MDWGN-ku2ZQ_YZYmgD/n/idch4uyl2yza/b/Racing2cloud_hackathon/o/DRIVER_STANDINGS.csv',    
	format => json_object('type' value 'csv', 'ignoremissingcolumns' value 'true', 'blankasnull' value 'true' ,'skipheaders' value '1'));
